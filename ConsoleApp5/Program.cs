namespace ConsoleApp5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (BinaryReader reader = new BinaryReader(File.Open("d:\\" + name + ".bmp", FileMode.Open)))
            {
                /*
                ...
                */
                ...
                Console.WriteLine($"Тип сжатия: {zipType}");
                /*
                        0 = BI_RGB (без сжатия)
                ...
                */
                ...
                Console.WriteLine($"Размер сжатого изображения в байтах: {zipImgSize}");
